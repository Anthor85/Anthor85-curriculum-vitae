...
export const FormacionComplementariaCard = ({ formacionComplementaria, deleteFormacionComplementaria }: Props) => {
	...
	return (
		<div className={styles.Card} key={id}>
			...
			<div className={styles.actions}>
				<button onClick={() => deleteFormacionComplementaria(id)}>Eliminar</button>
			</div>
		</div>
	);
};